...
class TestPatientAppModels(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.snp_1 = SingleNucPol.objects.create(
            rs='rs1', gene_name_short='GENE1',
            nuc_var_1='G', nuc_var_2='A')
        cls.snp_2 = SingleNucPol.objects.create(
            rs='rs2', gene_name_short='GENE2',
            nuc_var_1='C', nuc_var_2='T')
        cls.snp_3 = SingleNucPol.objects.create(
            rs='rs3', gene_name_short='GENE3',
            nuc_var_1='T', nuc_var_2='A')
        cls.snp_4 = SingleNucPol.objects.create(
            rs='rs4', gene_name_short='GENE4',
